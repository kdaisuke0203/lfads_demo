...
#         pdb.set_trace()
    ...
    def generate(self, x):
        ...
        for t in range(self.T):
            ...
            self.kl_loss = self.kl_loss + .1*KLCostGaussian(self.u_mean, self.u_logvar,
            ...
            if t>0:
                ...
                for i in range(b_size):
                    ...
                    self.dir_loss += 1*((f_his[t][i][0]-f_his[t-1][i][0])*(f_his[t][i][0]-f_his[t-1][i][0])*(x[i,t,8]+x[i,t,18]+x[i,t,21]+x[i,t,27]+x[i,t,28]+x[i,t,32]+x[i,t,34]) +
                                        (f_his[t][i][1]-f_his[t-1][i][1])*(f_his[t][i][1]-f_his[t-1][i][1])*(x[i,t,2]+x[i,t,5]+x[i,t,7]+x[i,t,10]+x[i,t,11]+x[i,t,14]+x[i,t,17]+x[i,t,19]+x[i,t,22]+x[i,t,23]+x[i,t,33])).sum()
